...
export function SurpriseSection({ onOpenSurprise }: SurpriseSectionProps) {
  ...
  const handleOpen = () => {
    setIsOpening(true);
    // Build suspenseful anticipation (1.2s bloom) before triggering the grand final celebration
    setTimeout(() => {
      onOpenSurprise();
    }, 1200);
  };
  ...
  return (
    <section
      id="surprise"
      ref={containerRef}
      className="relative w-full min-h-[90vh] py-32 px-6 flex flex-col items-center justify-center bg-[#05050A] text-center overflow-hidden"
    >
      {/* Dimmed backdrop with deep stillness */}
      ...
      <div className="relative z-10 max-w-2xl mx-auto flex flex-col items-center">
        ...
        <motion.p
          ...
          animate={isInView ? { opacity: 0.7, y: 0, filter: "blur(0px)" } : {}}
        ...
        {/* Subtle button: "Open Your Surprise ♡" */}
        <motion.button
